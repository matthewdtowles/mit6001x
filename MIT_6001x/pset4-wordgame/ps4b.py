...
def playGame(wordList):
    ...
    thisHand = ''
    while True:
        gameMode = input("Enter 'n' for new hand. Enter 'r' to replay last hand. Enter 'e' to exit: ")
        if gameMode not in 'nre':
            print("Invalid entry.")
        elif gameMode in 'nr':
            if gameMode == 'r' and thisHand == '':
